...
const LeadFormScreen = () => {
  ...
  useEffect(() => {
    if (!isNew && id && existingLead) {
      setFormData(existingLead);
    }
  }, [isNew, id, existingLead]);
        ...
        <Tabs defaultValue="basic">
          ...
          <TabsContent value="preferences" className="space-y-4 mt-6">
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="space-y-2">
                ...
                >
                  ...
                  <SelectContent>
                    ...
                    <SelectItem value="Modify My Diet">
                      Modify My Diet
                    </SelectItem>
              ...
              <div className="space-y-2">
                <Label htmlFor="primaryFitnessFocus">
              ...
              <div className="space-y-2">
                ...
                <Select
                  ...
                  onValueChange={(v) =>
                    handleChange("previousGymExperience", v)
                  }
                >
